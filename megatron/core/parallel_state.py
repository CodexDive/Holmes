...
from .hetnet import new_process_group, set_nccl_ib_envs, set_nccl_socket_envs
...
def initialize_model_parallel(
    ...
    for i in range(pipeline_model_parallel_size):
        ...
        for j in range(tensor_model_parallel_size):
            ...
            group_gloo = new_process_group(ranks, backend="gloo")
            if rank in ranks:
    ...
    for i in range(num_pipeline_model_parallel_groups):
        ...
        group = new_process_group(embedding_ranks)
        ...
        group = new_process_group(position_embedding_ranks)
