...
from megatron.core.models.common.embeddings.rotary_pos_embedding_chatglm3 import  RotaryEmbeddingChatglm3
...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(self,
        ...
        self.use_flash_attn_rope = (self.args.use_rotary_emb_implement == 'flash_attn') \
                                and (self.args.rotary_percent == 1.0) and (self.args.rotary_seq_len_interpolation_factor is None)
        ...
        if self.use_rotary_position_embeddings:
            ...
            if args.chatglm3_rotary_embed:
                self.rotary_pos_emb = RotaryEmbeddingChatglm3(rotary_dim // 2, original_impl=True, device=torch.cuda.current_device(),
                                              dtype=args.params_dtype)
            elif not self.use_flash_attn_rope:
                if args.rank == 0:
                    print("use native or apex rotary emb")
                ...
                if args.rank == 0:
                    print("use flash_attn fused rotary emb")
                self.rotary_pos_emb = RotaryEmbeddingFuse(rotary_dim)
    ...
    def forward(self, enc_input_ids, enc_position_ids, enc_attn_mask,
        ...
        if self.use_rotary_position_embeddings:
            if self.args.chatglm3_rotary_embed:
                ...
                if enc_position_ids is not None:
                    rotary_pos_emb = rotary_pos_emb[enc_position_ids]
                else:
