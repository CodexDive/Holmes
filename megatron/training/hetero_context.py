...
class ProcessMesh:
    ...
    def __init__(self, dims, dim_names):
        ...
        assert len(self._dim_names) == len(set(self._dim_names)), \
...
class HeteroContext:
    ...
    def _build_process_mesh(self, args):
        ...
        self._default_process_mesh=ProcessMesh(dims, dim_names)
    ...
    def _build_rank_mapping(self):
        ...
        for default_rank in range(self._world_size):
            # default_coord = self._new_process_mesh.get_coord(default_rank)
