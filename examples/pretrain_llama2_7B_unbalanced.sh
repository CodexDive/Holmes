...
DATA_PATH=/software/home/meli/megatron/data/oscar-en-10k-meg-llama_text_document
...
TOKENIZER_PATH=/software/home/meli/megatron/data/tokenizer.model
...
DISTRIBUTED_ARGS=" \
       ...
       --pipline-num-layers-list 3 3 4 4 4 4 5 5 \
...
RECOMPUTE_ARGS="
       ...
       --recompute-num-layers-list 1 1 2 2 3 3 4 4 \
"
