...
export USE_TDUMP=0FF # optional, use to control whether generating debug file
export TMEM_LOG=0FF # optional, use to control whether generating debug fileexport DEBUG ITRAcE=0 # optional, use to control whether generating debug file#export WCUDA DEBUG=1
#export VL1 CACHE POLICY=1
export MACA_SMALL_PAGESIZE_ENABLE=1
...
#export MAX_JOBS=20
#export LD_LIBRARY_PATH=/software/home/lyt/yidian_blas:$LD_LIBRARY_PATH


export MCCL_BUFFSIZE=8388608
export NCCL_BUFFSIZE=8388608
#export MCCL_P2P_NCHANNELS=2 
#export MCCL_P2P_NCHANNELS_PEER=2 
export MCCL_ALGO=Ring
export NCCL_ALGO=Ring
export MCCL_PROTO=Simple
...
DATA_PATH=/wangfangyu/test/megatron-mx/Megatron-LM/data/llama/oscar/my-llama_text_document
...
TOKENIZER_PATH=/wangfangyu/test/megatron-mx/Megatron-LM/data/llama/tokenizer.model
