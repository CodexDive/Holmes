...
elif [ ${MODEL_SIZE} == 70 ];  then HIDDEN_SIZE=8192;  NUM_HEAD=64; NUM_QUERY_GROUP=8;  NUM_LAYERS=8; FFN_HIDDEN_SIZE=28672; NORM_EPS=1e-5;
...
# Paths
BASE_PATH=/model_and_data/oscar-en-10k
SRC_PATH=../pretrain_llama.py

LOG_NAME=llama2-70b_pretrain_WS${WORLD_SIZE}_TP${TP}_PP${PP}
LOG_PATH=./log/${LOG_NAME}/node${NODE_RANK}.log
mkdir -p ./log
mkdir -p ./log/${LOG_NAME}
